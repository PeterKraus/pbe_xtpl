...
extrapolations = {
    "cc-pv[dt]z": {"comps": ["cc-pvdz", "cc-pvtz"], "zetas": [2,3], "α0": 3.622, "αx": 1.511, "αc": 0.005, "αdh": 2.4},
    "cc-pv[tq]z": {"comps": ["cc-pvtz", "cc-pvqz"], "zetas": [3,4], "α0": 3.622, "αx": 1.511, "αc": 0.005, "αdh": 3.0},
    "cc-pv[dt]z-pp": {"comps": ["cc-pvdz-pp", "cc-pvtz-pp"], "zetas": [2,3], "α0": 3.622, "αx": 1.511, "αc": 0.005, "αdh": 2.4},
    "cc-pv[tq]z-pp": {"comps": ["cc-pvtz-pp", "cc-pvqz-pp"], "zetas": [3,4], "α0": 3.622, "αx": 1.511, "αc": 0.005, "αdh": 3.0},
    "aug-cc-pv[dt]z": {"comps": ["aug-cc-pvdz", "aug-cc-pvtz"], "zetas": [2,3], "α0": 3.676, "αx": 1.887, "αc": 0.139, "αdh": 2.4},
    "aug-cc-pv[tq]z": {"comps": ["aug-cc-pvtz", "aug-cc-pvqz"], "zetas": [3,4], "α0": 3.676, "αx": 1.887, "αc": 0.139, "αdh": 3.0},
    "def2-[st]zvp": {"comps": ["def2-svp", "def2-tzvp"], "zetas": [2,3], "α0": 7.406, "αx": 1.266, "αc": -0.046, "αdh": 2.4},
    "def2-[st]zvpp": {"comps": ["def2-svp", "def2-tzvpp"], "zetas": [2,3], "α0": 7.408, "αx": 1.267, "αc": -0.046, "αdh": 2.4},
    "def2-[st]zvpd": {"comps": ["def2-svpd", "def2-tzvpd"], "zetas": [2,3], "α0": 7.925, "αx": 1.370, "αc": 0.101, "αdh": 2.4},
    "def2-[st]zvppd": {"comps": ["def2-svpd", "def2-tzvppd"], "zetas": [2,3], "α0": 7.927, "αx": 1.371, "αc": 0.101, "αdh": 2.4},
    ...
    "cc-pwcv[dt]z": {"comps": ["cc-pwcvdz", "cc-pwcvtz"], "zetas": [2,3], "α0": 4.157, "αx": 1.192, "αc": -0.048, "αdh": 2.4},
    "cc-pwcv[tq]z": {"comps": ["cc-pwcvtz", "cc-pwcvqz"], "zetas": [3,4], "α0": 4.157, "αx": 1.192, "αc": -0.048, "αdh": 3.0},
    "aug-cc-pwcv[dt]z": {"comps": ["aug-cc-pwcvdz", "aug-cc-pwcvtz"], "zetas": [2,3], "α0": 4.485, "αx": 1.445, "αc": 0.085, "αdh": 2.4},
    "aug-cc-pwcv[tq]z": {"comps": ["aug-cc-pwcvtz", "aug-cc-pwcvqz"], "zetas": [3,4], "α0": 4.485, "αx": 1.445, "αc": 0.085, "αdh": 3.0},
    "pcseg-[12]": {"comps": ["pcseg-1", "pcseg-2"], "zetas": [2,3], "α0": 5.883, "αx": -1.825, "αc": 0.227, "αdh": 2.4},
    "pcseg-[23]": {"comps": ["pcseg-2", "pcseg-3"], "zetas": [3,4], "α0": 5.883, "αx": -1.825, "αc": 0.227, "αdh": 3.0},
    "aug-pcseg-[12]": {"comps": ["aug-pcseg-1", "aug-pcseg-2"], "zetas": [2,3], "α0": 6.166, "αx": -2.137, "αc": 0.296, "αdh": 2.4},
